...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    @ResultIgnorabilityUnspecified
    public static boolean showErrorDialogFragment(int i, Activity activity, n nVar, int i2, DialogInterface.OnCancelListener onCancelListener) {
        if (true == GooglePlayServicesUtilLight.isPlayServicesPossiblyUpdating(activity, i)) {
            i = 18;
        }
        int i3 = i;
        ...
        Dialog dialogZaa = googleApiAvailability.zaa(activity, i3, zag.zac(nVar, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i3, "d"), i2), onCancelListener, null);
        if (dialogZaa == null) {
            return false;
        }
