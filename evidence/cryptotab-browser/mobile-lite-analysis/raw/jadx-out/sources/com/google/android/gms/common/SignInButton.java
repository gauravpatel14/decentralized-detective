...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zad = null;
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, AbstractC0305Yp1.SignInButton, 0, 0);
        try {
            this.zaa = typedArrayObtainStyledAttributes.getInt(AbstractC0305Yp1.SignInButton_buttonSize, 0);
            this.zab = typedArrayObtainStyledAttributes.getInt(AbstractC0305Yp1.SignInButton_colorScheme, 2);
