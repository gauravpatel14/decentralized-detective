...
public abstract class GoogleApiClient {
    ...
    public final class Builder {
        ...
        public Builder addApiIfAvailable(Api api, Api.ApiOptions.HasOptions hasOptions, Scope... scopeArr) {
            ...
            this.zaj.put(api, hasOptions);
            zab(api, hasOptions, scopeArr);
            return this;
        }
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                gfVar.put(api2, Boolean.valueOf(z2));
                ...
                gfVar2.put(api2.zab(), clientBuildClient);
                if (abstractClientBuilder.getPriority() == 1) {
                    z = obj != null;
                }
                if (clientBuildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(F.b(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z) {
                    throw new IllegalStateException(BN0.a("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, gfVar, this.zaq, this.zar, gfVar2, this.zal, zabe.zad(gfVar2.values(), true), arrayList);
        ...
        public final ClientSettings zaa() {
            EI1 ei1 = EI1.t;
            Map map = this.zaj;
            Api api = AbstractC0169Nz2.b;
            if (map.containsKey(api)) {
                ei1 = (EI1) this.zaj.get(api);
            }
            return new ClientSettings(this.zaa, this.zab, this.zah, this.zad, this.zae, this.zaf, this.zag, ei1, false);
        }
        ...
        public Builder addApi(Api api, Api.ApiOptions.HasOptions hasOptions) {
            ...
            Preconditions.checkNotNull(hasOptions, "Null options are not permitted for this Api");
            this.zaj.put(api, hasOptions);
            List impliedScopes = ((Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes(hasOptions);
            this.zac.addAll(impliedScopes);
            this.zab.addAll(impliedScopes);
            return this;
        }
