...
import defpackage.C0115Jy2;
import defpackage.C0123Ky2;
...
public final class zaad {
    ...
    private final void zah(boolean z, Status status) {
        ...
        for (Map.Entry entry2 : map2.entrySet()) {
            if (z || ((Boolean) entry2.getValue()).booleanValue()) {
                ((H62) entry2.getKey()).c(new ApiException(status));
            }
        }
    }
    ...
    public final void zac(BasePendingResult basePendingResult, boolean z) {
        ...
        basePendingResult.addStatusListener(new C0115Jy2(this, basePendingResult));
    }

    public final void zad(H62 h62, boolean z) {
        this.zab.put(h62, Boolean.valueOf(z));
        h62.a.a(new C0123Ky2(this, h62));
    }
