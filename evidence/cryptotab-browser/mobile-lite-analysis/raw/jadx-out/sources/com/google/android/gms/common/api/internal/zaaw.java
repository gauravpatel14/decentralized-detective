...
import defpackage.C0202Qy2;
import defpackage.C0243Ty2;
import defpackage.InterfaceC0254Uz2;
import defpackage.RunnableC0167Ny2;
...
public final class zaaw implements zabf {
    ...
    private final void zaB(boolean z) {
        InterfaceC0254Uz2 interfaceC0254Uz2 = this.zak;
        if (interfaceC0254Uz2 != null) {
            if (interfaceC0254Uz2.isConnected() && z) {
                interfaceC0254Uz2.zaa();
            }
    ...
    private final void zaC() {
        this.zaa.zai();
        zabj.zaa().execute(new RunnableC0167Ny2(this));
        InterfaceC0254Uz2 interfaceC0254Uz2 = this.zak;
        if (interfaceC0254Uz2 != null) {
            if (this.zap) {
                interfaceC0254Uz2.a((IAccountAccessor) Preconditions.checkNotNull(this.zao), this.zaq);
            }
            zaB(false);
        }
    ...
    public final void zaF() {
        ...
        if (!this.zam || this.zan) {
            ...
            this.zau.add(zabj.zaa().submit(new d(this, arrayList)));
        }
    }
    ...
    /* JADX WARN: Type inference failed for: r0v13, types: [Uz2, com.google.android.gms.common.api.Api$Client] */
    @Override // com.google.android.gms.common.api.internal.zabf
    public final void zad() {
        ...
        for (Api api : this.zas.keySet()) {
            ...
            map.put(client, new c(this, api, zBooleanValue));
        }
        if (z) {
            this.zam = false;
        }
        if (this.zam) {
            ...
            C0243Ty2 c0243Ty2 = new C0243Ty2(this);
            Api.AbstractClientBuilder abstractClientBuilder = this.zat;
            Context context = this.zac;
            zabi zabiVar = this.zaa;
            ClientSettings clientSettings = this.zar;
            this.zak = abstractClientBuilder.buildClient(context, zabiVar.zag.getLooper(), clientSettings, (Object) clientSettings.zaa(), (GoogleApiClient.ConnectionCallbacks) c0243Ty2, (GoogleApiClient.OnConnectionFailedListener) c0243Ty2);
        }
        this.zah = this.zaa.zaa.size();
        this.zau.add(zabj.zaa().submit(new C0202Qy2(this, map)));
    }
