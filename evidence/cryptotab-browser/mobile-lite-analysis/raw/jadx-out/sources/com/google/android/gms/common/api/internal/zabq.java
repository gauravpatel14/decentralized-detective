...
import defpackage.C1418rz2;
import defpackage.H62;
import defpackage.RunnableC1121mz2;
import defpackage.RunnableC1182nz2;
...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final Feature zaC(Feature[] featureArr) {
        if (featureArr != null && featureArr.length != 0) {
            ...
            gf gfVar = new gf(availableFeatures.length);
            for (Feature feature : availableFeatures) {
                gfVar.put(feature.getName(), Long.valueOf(feature.getVersion()));
            }
            for (Feature feature2 : featureArr) {
                Long l = (Long) gfVar.get(feature2.getName());
    ...
    public final void zaH() {
        ...
        while (it.hasNext()) {
            ...
            if (zaC(zaciVar.zaa.getRequiredFeatures()) != null) {
                ...
                try {
                    zaciVar.zaa.registerListener(this.zac, new H62());
    ...
    private final boolean zaM(zai zaiVar) {
        ...
        C1301pz2 c1301pz2 = new C1301pz2(this.zad, featureZaC);
        int iIndexOf = this.zak.indexOf(c1301pz2);
        if (iIndexOf >= 0) {
            C1301pz2 c1301pz22 = (C1301pz2) this.zak.get(iIndexOf);
            this.zaa.zar.removeMessages(15, c1301pz22);
            GoogleApiManager googleApiManager = this.zaa;
            googleApiManager.zar.sendMessageDelayed(Message.obtain(googleApiManager.zar, 15, c1301pz22), 5000L);
            return false;
        }
        this.zak.add(c1301pz2);
        GoogleApiManager googleApiManager2 = this.zaa;
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 15, c1301pz2), 5000L);
        GoogleApiManager googleApiManager3 = this.zaa;
        googleApiManager3.zar.sendMessageDelayed(Message.obtain(googleApiManager3.zar, 16, c1301pz2), 120000L);
    ...
    public static /* bridge */ /* synthetic */ void zal(zabq zabqVar, C1301pz2 c1301pz2) {
        if (zabqVar.zak.contains(c1301pz2) && !zabqVar.zaj) {
    ...
    public static /* bridge */ /* synthetic */ void zam(zabq zabqVar, C1301pz2 c1301pz2) {
        Feature[] featureArrZab;
        if (zabqVar.zak.remove(c1301pz2)) {
            zabqVar.zaa.zar.removeMessages(15, c1301pz2);
            zabqVar.zaa.zar.removeMessages(16, c1301pz2);
            Feature feature = c1301pz2.b;
    ...
    public final void onConnected(Bundle bundle) {
        if (Looper.myLooper() == this.zaa.zar.getLooper()) {
            ...
            this.zaa.zar.post(new RunnableC1121mz2(this));
        }
    }
    ...
    public final void onConnectionSuspended(int i) {
        if (Looper.myLooper() == this.zaa.zar.getLooper()) {
            ...
            this.zaa.zar.post(new RunnableC1182nz2(this, i));
        }
    }
    ...
    public final void zao() {
        ...
        try {
            ...
            C1418rz2 c1418rz2 = new C1418rz2(googleApiManager2, client, this.zad);
            if (client.requiresSignIn()) {
                ((zact) Preconditions.checkNotNull(this.zai)).zae(c1418rz2);
            }
            try {
                this.zac.connect(c1418rz2);
    ...
    public final void zav() {
        ...
        for (ListenerHolder.ListenerKey listenerKey : (ListenerHolder.ListenerKey[]) this.zag.keySet().toArray(new ListenerHolder.ListenerKey[0])) {
            zap(new zah(listenerKey, new H62()));
        }
        zaD(new ConnectionResult(4));
        if (this.zac.isConnected()) {
            this.zac.onUserSignOut(new e(this));
        }
    }
