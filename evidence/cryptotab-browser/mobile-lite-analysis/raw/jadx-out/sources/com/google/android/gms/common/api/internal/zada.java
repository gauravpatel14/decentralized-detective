...
import defpackage.HandlerC0088Gz2;
...
public final class zada extends TransformedResult implements ResultCallback {
    ...
    private final HandlerC0088Gz2 zah;
    ...
    public zada(WeakReference weakReference) {
        ...
        this.zah = new HandlerC0088Gz2(this, googleApiClient != null ? googleApiClient.getLooper() : Looper.getMainLooper());
    }
        ...
        synchronized (this.zae) {
            try {
                if (!result.getStatus().isSuccess()) {
                    ...
                    zaco.zaa().submit(new f(this, result));
                } else if (zam()) {
