...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "GetServiceRequest.EMPTY_FEATURES", id = ConnectionResult.LICENSE_CHECK_FAILED)
    Feature[] zzl;
