...
import defpackage.C0560eA2;
import defpackage.C1006lA2;
...
public abstract class GmsClient extends BaseGmsClient implements Api.Client, zaj {
    ...
    public GmsClient(Context context, Looper looper, GmsClientSupervisor gmsClientSupervisor, GoogleApiAvailability googleApiAvailability, int i, ClientSettings clientSettings, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        super(context, looper, gmsClientSupervisor, googleApiAvailability, i, connectionCallbacks == null ? null : new C0560eA2(connectionCallbacks), onConnectionFailedListener == null ? null : new C1006lA2(onConnectionFailedListener), clientSettings.zac());
