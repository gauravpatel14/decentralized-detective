...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(AbstractC1214oR1.a(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(Vx1.a(iDataPosition, i, "Size read is invalid start=", " end="), parcel);
        }
        return i;
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        sb.append(i2);
        sb.append(" (0x");
        throw new ParseException(S3.a(sb, hexString, ")"), parcel);
    }
