...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                throw new IllegalStateException(AbstractC1214oR1.a(i, "Unsupported type for conversion: "));
            case 4:
                if (objZae != null) {
    ...
    @KeepForSdk
    public void addConcreteTypeArrayInternal(Field field, String str, ArrayList arrayList) {
        throw new UnsupportedOperationException("Concrete type array not supported");
    }

    @KeepForSdk
    public void addConcreteTypeInternal(Field field, String str, FastJsonResponse fastJsonResponse) {
    ...
    @KeepForSdk
    public void setStringMapInternal(Field field, String str, Map map) {
        throw new UnsupportedOperationException("String map not supported");
    }

    @KeepForSdk
    public void setStringsInternal(Field field, String str, ArrayList arrayList) {
    ...
    public class Field extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "getWrappedConverter", id = ConnectionResult.SERVICE_INVALID, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        private final FieldConverter zak;

        @SafeParcelable.Constructor
        public Field(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) boolean z, @SafeParcelable.Param(id = 4) int i3, @SafeParcelable.Param(id = 5) boolean z2, @SafeParcelable.Param(id = 6) String str, @SafeParcelable.Param(id = 7) int i4, @SafeParcelable.Param(id = 8) String str2, @SafeParcelable.Param(id = ConnectionResult.SERVICE_INVALID) zaa zaaVar) {
            this.zai = i;
            this.zaa = i2;
            this.zab = z;
            this.zac = i3;
        ...
        @KeepForSdk
        public static Field forBase64(String str, int i) {
        ...
        @KeepForSdk
        public static Field forDouble(String str, int i) {
            return new Field(4, false, 4, false, str, i, null, null);
        }

        @KeepForSdk
        public static Field forFloat(String str, int i) {
        ...
        @KeepForSdk
        public static Field forStringMap(String str, int i) {
