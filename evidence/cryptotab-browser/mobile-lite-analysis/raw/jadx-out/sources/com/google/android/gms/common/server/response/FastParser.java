...
import defpackage.C0052Dy2;
import defpackage.C0137Lz2;
import defpackage.C0230Sz2;
import defpackage.C0310Yz2;
import defpackage.C0385az2;
import defpackage.C0450cA2;
import defpackage.C0621fA2;
import defpackage.C1589uz2;
import defpackage.InterfaceC0883jA2;
...
public class FastParser {
    ...
    private static final InterfaceC0883jA2 zag = new C0052Dy2();
    private static final InterfaceC0883jA2 zah = new C0385az2();
    private static final InterfaceC0883jA2 zai = new C1589uz2();
    private static final InterfaceC0883jA2 zaj = new C0137Lz2();
    private static final InterfaceC0883jA2 zak = new C0230Sz2();
    private static final InterfaceC0883jA2 zal = new C0310Yz2();
    private static final InterfaceC0883jA2 zam = new C0450cA2();
    private static final InterfaceC0883jA2 zan = new C0621fA2();
    ...
    */
    ...
    private final ArrayList zau(BufferedReader bufferedReader, InterfaceC0883jA2 interfaceC0883jA2) throws ParseException, IOException {
        char cZai = zai(bufferedReader);
        if (cZai == 'n') {
            zax(bufferedReader, zaa);
            return null;
        ...
        while (true) {
            ...
            if (cZai2 != ',') {
                ...
                bufferedReader.reset();
                arrayList.add(interfaceC0883jA2.a(this, bufferedReader));
            }
        }
    }
    ...
    private final void zaw(int i) throws ParseException {
        ...
        if (iIntValue != i) {
            throw new ParseException(Vx1.a(i, iIntValue, "Expected state ", " but had "));
        }
    }
        ...
        try {
            try {
                ...
                if (cZai == '[') {
                    ...
                    this.zat.push(1);
                    zaz(bufferedReader, fastJsonResponse);
                }
                zaw(0);
                try {
