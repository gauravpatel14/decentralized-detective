...
public final class zzt {
    ...
    public static void zzn(final zzt zztVar, final H62 h62) {
        zztVar.zzf.add(h62);
        h62.a.a(new N41() { // from class: com.google.android.play.core.review.internal.zzl
            @Override // defpackage.N41
            public final void onComplete(G62 g62) {
                this.zza.zzt(h62, g62);
            }
        });
    }
    ...
    public final void zzs(zzj zzjVar, H62 h62) {
        zzc().post(new zzm(this, zzjVar.zzb(), h62, zzjVar));
    }

    public final /* synthetic */ void zzt(H62 h62, G62 g62) {
        synchronized (this.zzg) {
            this.zzf.remove(h62);
        }
    }

    public final void zzu(H62 h62) {
        synchronized (this.zzg) {
            this.zzf.remove(h62);
        }
