...
public final class C0573eL2 extends AbstractRunnableC1610vM2 {
    public final /* synthetic */ RH2 x;
    public final /* synthetic */ AN2 y;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0573eL2(AN2 an2, RH2 rh2) {
        super(an2, true);
        this.y = an2;
        this.x = rh2;
    }
    ...
    public final void a() {
        ((DI2) Preconditions.checkNotNull(this.y.f)).generateEventId(this.x);
    }
