...
public final class CV2 implements Runnable {
    ...
    public final void run() {
        ...
        if (interfaceC1086mO2 == null) {
            WO2 wo2 = c1391rR2.i;
            C1391rR2.k(wo2);
            wo2.f.a("Failed to reset data on the service: not connected to service");
            return;
        }
        try {
            Preconditions.checkNotNull(zzqVar);
            interfaceC1086mO2.g0(zzqVar);
        } catch (RemoteException e) {
            WO2 wo22 = c1391rR2.i;
            C1391rR2.k(wo22);
            wo22.f.b(e, "Failed to reset data on the service: remote exception");
        }
        cw2.r();
    }
}
