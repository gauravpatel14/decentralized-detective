...
public final class JQ0 extends Wn implements MenuItem {
    public final aS1 c;
    public Method d;

    public JQ0(Context context, aS1 as1) {
        super(context);
        if (as1 == null) {
    ...
    public final View getActionView() {
        ...
        return actionView instanceof GQ0 ? (View) ((GQ0) actionView).t : actionView;
    }
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider) {
        FQ0 fq0 = new FQ0(this, actionProvider);
    ...
    public final MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        this.c.setOnActionExpandListener(onActionExpandListener != null ? new HQ0(this, onActionExpandListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public final MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        this.c.setOnMenuItemClickListener(onMenuItemClickListener != null ? new IQ0(this, onMenuItemClickListener) : null);
        return this;
    }
    ...
    public final MenuItem setActionView(int i) {
        aS1 as1 = this.c;
        as1.setActionView(i);
        View actionView = as1.getActionView();
        if (actionView instanceof CollapsibleActionView) {
            as1.setActionView(new GQ0(actionView));
        }
        return this;
    }
}
