...
public final class Ub {
    ...
    public final int c(RectF rectF) {
        ...
        while (i2 <= i) {
            ...
            builderObtain.setAlignment(alignment).setLineSpacing(textView.getLineSpacingExtra(), textView.getLineSpacingMultiplier()).setIncludePad(textView.getIncludeFontPadding()).setBreakStrategy(textView.getBreakStrategy()).setHyphenationFrequency(textView.getHyphenationFrequency()).setMaxLines(maxLines == -1 ? Api.BaseClientBuilder.API_PRIORITY_OTHER : maxLines);
            try {
                qb.b(builderObtain, textView);
    ...
    public final boolean j() {
        return !(this.i instanceof C1038lb);
    }
