...
public final class Up2 {
    ...
    static {
        float[] fArr = lx.c;
        float fC = (float) ((((double) lx.c()) * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = lx.a;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        ...
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(((double) fC) * 5.0d))) + (f11 * fC);
        float fC2 = lx.c() / fArr[1];
        double d2 = fC2;
        ...
        k = new Up2(fC2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public Up2(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
