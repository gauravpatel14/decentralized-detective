...
const scamFrontendCode = `// File: BitMiner.apk — static teardown notes
//
...
export const bitminerApkCase: InvestigationReport = {
    ...
    // 🟢 Using 'as any' directly overrides type structural limits without losing data!
    evidence: [
        {
            id: '1',
...
Practical Phase-3 cost      : To patch-and-run with substituted
        ...
        {
            id: '10',
            title: 'Evidence #10: What The App Actually Does (Behavioral Model)',
            type: 'text',
...
Per-user fields exposed (every record has these):
  ...
  Updated_at     : Birthday of last in-app activity (53.5% of users)
  ...
  (Caveat: a private payout log could exist under a name
   ...
   Also probed and found nothing for this project.)`,
    ...
    findings: [
        ...
        {
            title: 'Android-Specific Build File Configurations Checked',
            description: 'The codebase has been checked strictly for compilation pathways. Internal static types are verified and assertions applied safely.',
            tags: ['Compilation Clear', 'Checked', 'Resolved'],
        }
    ],
